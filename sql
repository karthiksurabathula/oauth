----Create JKS Key file for JWT file -- Created for 100 Years :
"C:\Program Files"\Java\jdk1.8.0_172\bin\keytool.exe -genkeypair -alias jwt -keyalg RSA -keypass password@123 -keystore jwt.jks -storepass password@123 -validity 36500
"C:\Program Files"\Java\jdk1.8.0_172\bin\keytool -importkeystore -srckeystore jwt.jks -destkeystore jwt.jks -deststoretype pkcs12
